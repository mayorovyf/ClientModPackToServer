...
import type { DependencyEdge, DependencyFinding, DependencyGraphSummary } from '../types/dependency';
...
function createDependencyFinding({
    ...
    loaderOrigin?: DependencyEdge['loaderOrigin'] | null;
    versionRange?: string | null;
    sideHint?: DependencyEdge['sideHint'] | null;
}): DependencyFinding {
    return {
        type,
        severity,
...
function buildFindingSummary(findings: DependencyFinding[] = [], graphSummary: Partial<DependencyGraphSummary> = {}): DependencyGraphSummary {
