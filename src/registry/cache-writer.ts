...
function safeCopy(sourcePath: string, destinationPath: string): void {
...
function activateRegistryCache(layout: RegistryCacheLayout, { manifestText, bundleText }: { manifestText: string; bundleText: string }) {
